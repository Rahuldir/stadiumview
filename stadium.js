/* ══════════════════════════════════════════════════════════════
   StadiumView — scene builder (clean, hardcoded pitch)
   • Loads: stadium.glb, newplayer.glb, bat.glb, stump.glb
   • Pitch surface = Y 7.19 (verified via raycast diagnostic)
   • 15 players + 2 stumps + ball all on the pitch
   ══════════════════════════════════════════════════════════════ */
(function(){
  'use strict';
  ...
  // ─── HARDCODED, verified from raycast ──────────────────────
  const FIELD_Y = 7.19;
  ...
  async function boot(){
    ...
    console.log('[stadium.js] ✅ ready · fieldY=' + FIELD_Y + ' · players=' +
                Object.keys(playerRefs).length);
  }
